 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_skills_overview_form extends moodleform {
    ...
    public function definition() {
		...
		$mform->addElement('select', 'currentyear', get_string('currentyear','skills'), skills_get_array_years(), array('class'=>'input-width'));
		$mform->addHelpButton('currentyear', 'currentyear', 'skills');
