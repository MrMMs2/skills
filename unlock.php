...
if($confirm && $dtfid && has_capability('mod/skills:submit', $context)){
	...
	$message = "Prezado(a) ".skills_get_serFullName().", Relatório desbloqueado com sucesso! A partir desse momento, o representante poderá alterá-lo.";
	redirect($CFG->wwwroot.'/mod/skills/overview.php?id='.$cm->id.'&perpage=30&page=0', $message, 5);
}
$message = "Não foi possível desbloquear o relatório.";
redirect($CFG->wwwroot.'/mod/skills/overview.php?id='.$cm->id.'&perpage=30&page=0', $message, 5);